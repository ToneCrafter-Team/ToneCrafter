...
#define AI_SINE_MODEL_MODEL_SIGNATURE     "0eb158416c801343327f17799db97a2d"
...
#define AI_TOOLS_DATE_TIME   "Mon Dec 13 11:51:32 2021"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    dense_1_weights_array.data = AI_PTR(weights_map[0] + 192);
    dense_1_weights_array.data_start = AI_PTR(weights_map[0] + 128);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights_map[0] + 320);
    dense_1_bias_array.data_start = AI_PTR(weights_map[0] + 320);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights_map[0] + 384);
    dense_2_weights_array.data_start = AI_PTR(weights_map[0] + 384);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights_map[0] + 448);
    dense_2_bias_array.data_start = AI_PTR(weights_map[0] + 448);
    return true;
  }
  return false;
}
