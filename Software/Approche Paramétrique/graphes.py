# -*- coding: utf-8 -*-
"""
Created on Sun May  2 16:05:07 2021

@author: duwat
"""
import librosa
import numpy as np
x, sr = librosa.load('G53-41101-1111-00002.wav',offset=0)
y=x
...
D = librosa.amplitude_to_db(np.abs(librosa.stft(x, n_fft=ro, hop_length=hop_length)),
                            ref=np.max)
